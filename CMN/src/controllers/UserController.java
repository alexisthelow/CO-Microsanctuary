...
public class UserController {
	...
	/**
	 * Checks user login if successful, redirects to index, changes authUser and loggedIn
	...
	/**
	 * logs out active user, hopefully, but tbh i don't really know yet
	 ...
	 * @param dto		-- data transfer object for user info
	 * @param session	-- sets new user into session
	 * @return
	 */
	...
	/**
	 * shows an error page on 400/404/500 response
	 * @return
	 */
	...
	/**
	 * shows admin page for updating a user
	 * @param id		-- user's id
	 * @return
	 */
	...
	/**
	 * shows admin page for updating a single item
	 * @param id		-- item's id
	 * @return
	 */
	...
	/**
	 * completes admin item update
	 * @param item		-- command object of the item being updated
	 * @return
	 */
	...
	/**
	 * shows admin page to update a single borrow request
	...
	/**
	 * completes admin activity update
	 * @param activity	-- command object of the request
	 * @return
	 */
	...
	/**
	 * shows user page to update their own info
	 * @param session	-- gets the user object of the logged in user
	 * @return
	 */
	...
	/**
	 * processes user update info
	 * @param dto		-- data transfer object for user info
	 * @param session	-- resets current user to logged in user
	 * @return
	 */
	...
	/**
	 * shows user page to update one of their items
	...
	/**
	 * completes user item update
	 * @param item	-- command object of item to be updated
	 * @return
	 */
	...
	/**
	 * shows all user items
	 * @param session	-- shows the items of logged in user
	 * @return
	 */
